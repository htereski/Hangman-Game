    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      ...
      <div class="relative group w-96 mb-4">
        <div class="icons flex justify-between items-start p-5 group-hover:opacity-100 opacity-0 transition-opacity duration-300 absolute top-0 left-0 right-0 z-30">
            ...
            <dialog id="my_modal_2" class="modal">
              <div class="modal-box">
                ...
                <h1>{{$category->id}}</h1>
                  ...
                  <div class="flex gap-4">
                    <button type="button" onclick="my_modal_2.close()" class="btn btn-secondary">Cancelar</button>
                    <button type="submit" class="btn btn-primary">Criar Categoria</button>
                  </div>
                </form>
              </div>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-primary cursor-pointer"  onclick="my_modal_3.showModal()">
        ...
        <dialog id="my_modal_3" class="modal">
          <div class="modal-box">
            ...
            <div class="flex gap-4">
              <button type="button" onclick="my_modal_3.close()" class="btn btn-secondary">Cancelar</button>
